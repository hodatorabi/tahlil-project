...
const actionTypes = {
  ...
  CREATE_NON_CASH_PROJECT: asyncActionTypeCreator('CREATE_NON_CASH_PROJECT'),
  CREATE_PROJECT_TIME_SLOT: asyncActionTypeCreator('CREATE_PROJECT_TIME_SLOT'),
  GET_PROJECT_TIME_SLOTS: asyncActionTypeCreator('GET_PROJECT_TIME_SLOTS'),
  CREATE_CASH_PROJECT: asyncActionTypeCreator('CREATE_CASH_PROJECT'),
  SEARCH_VOLUNTEERS: asyncActionTypeCreator('SEARCH_VOLUNTEERS'),
