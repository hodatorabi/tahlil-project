...
const volunteerNonCashProjects = (state = [], action) => {
  switch (action.type) {
    case actionTypes.GET_VOLUNTEER_NON_CASH_PROJECTS.SUCCESS:
      return action.response
    case actionTypes.LOGOUT:
      return []
    default:
...
const volunteerCashProjects = (state = [], action) => {
  switch (action.type) {
    case actionTypes.GET_VOLUNTEER_CASH_PROJECTS.SUCCESS:
      return action.response
    case actionTypes.LOGOUT:
      return []
    default:
...
const searchResultsProjects = (state = [], action) => {
  switch (action.type) {
    case actionTypes.SEARCH_CASH_PROJECTS.SUCCESS:
    case actionTypes.SEARCH_NON_CASH_PROJECTS.SUCCESS:
      return action.response
    case actionTypes.LOGOUT:
      return []
    default:
...
const reducers = combineReducers({
  ...
  charityCashProjects,
  volunteers,
  volunteerNonCashProjects,
  volunteerCashProjects,
