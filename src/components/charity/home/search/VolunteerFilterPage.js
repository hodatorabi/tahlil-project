...
class VolunteerFilterPage extends React.Component<Props, State> {
    ...
    return (
      <View style={{justifyContent: 'flex-start', flex: 1, alignItems: 'center'}}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}
          ...
          <View style={style.itemContainerStyle}>
            <Label text={'زمان‌ آزاد نیکوکار:'} textStyle={{fontSize: 16}}
...
export default Auth.providers.auth(VolunteerFilterPage)
