...
import RateItemGroup from 'src/components/common/RateItemGroup'


class FeedbackPopup extends React.Component<Props, void> {
      ...
      >
        ...
        >
          <Label style={{marginTop: -10, marginBottom: 20, width: '90%', alignSelf: 'center'}}
                 ...
                 text={messages.CLICK_ON_RATING}/>

          <RateItemGroup onChangeValue={(value) => this.onValueChange(value)}/>

          <Label style={{marginTop: 10, marginBottom: 20, width: '95%', alignSelf: 'center'}}
                 textStyle={{fontSize: 16, color: COLOR_BLACK}}
                 text={messages.ENTER_FEEDBACK}/>
...
export default Projects.providers.projects(FeedbackPopup)